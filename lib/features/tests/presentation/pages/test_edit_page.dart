...
class _TestEditPageState extends State<TestEditPage> {
  ...
  Future<void> _updateTest() async {
    ...
    try {
      ...
      // Update test using TestsCubit
      final success = await _testsCubit.updateExistingTest(widget.testId, updatedTest);
      ...
      if (success) {
        ...
        _snackBarCubit.showErrorLocalized(
          korean: '시험 수정에 실패했습니다',
          english: 'Failed to update test',
        );
      }
