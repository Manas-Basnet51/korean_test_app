...
class _TestResultsHistoryPageState extends State<TestResultsHistoryPage> {
  ...
  Future<void> _loadResults() async {
    ...
    try {
      ...
      // Get test results using TestsCubit
      final results = await _testsCubit.getTestResultsWithHandling();
  ...
  // Remove the _generateMockResults method since we're using real data now
